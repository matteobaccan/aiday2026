...
footer: 'A.I. DAY 2026 | Matteo Baccan | versione del %date% %time%'
...
<!-- _backgroundImage: url('img/cover.jpg') -->
<!-- _paginate: false -->
<!-- _footer: "" -->
...
<!-- _header: '' -->
<!-- _class: section-title -->
<!-- _backgroundImage: url('img/sponsor.png') -->
<!-- _paginate: false -->
<!-- _footer: "" -->
...
## NON-GOAL
- Non implementare refresh token (non richiesto)
...
Più alto, ma meno bug, meno riscritture, onboarding più rapido.
